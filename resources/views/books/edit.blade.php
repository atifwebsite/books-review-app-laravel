                    ...
                    <form action="{{ route('books.update',$book->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                  ...
                                  @error('title') is-invalid  @enderror"
                                    value="{{ old('title', $book->title) }}" placeholder="Title" name="title"
                                    id="title" />
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                @if (!empty($book->image))
                                    <img class="w-25 my-2" height="190" src="{{ asset('uploads/books/' . $book->image) }}"
                                        alt="">
                                @endif
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="status" id="status"
                                   ...
                                   @error('status') is-invalid  @enderror">
                                    ...
                                    <option value="0" {{ $book->status == 0 ? 'selected' : '' }}>De Active</option>
                                </select>
                                @error('status')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
